...
module.exports = function getOptions(env){
	...
	const OUT = 
		{ ASSETS:p([DIRS.ASSETS])
		, CSS:p([DIRS.ASSETS_OUTPUT,DIRS.CSS_OUTPUT,STYLE_BUNDLE_NAME+'.css'])
		, CLIENT:p([DIRS.ASSETS_OUTPUT,DIRS.CLIENT_OUTPUT,CLIENT_BUNDLE_NAME])
		, FONTS:p([DIRS.ASSETS,DIRS.FONTS_OUTPUT])
		, IMAGES:p([DIRS.ASSETS,DIRS.IMAGES])
		, SERVER:p([DIRS.SERVER_OUTPUT,SERVER_BUNDLE_NAME])
		}
